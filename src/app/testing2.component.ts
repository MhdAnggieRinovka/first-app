...
import { NgFor, NgIf, NgStyle, NgSwitch, NgSwitchCase, NgSwitchDefault, NgTemplateOutlet, UpperCasePipe,NgComponentOutlet } from '@angular/common';
...
//             NgStyle, PostListComponent,CardComponent,NgComponentOutlet],
